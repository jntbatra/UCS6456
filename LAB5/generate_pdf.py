#!/usr/bin/env python3
"""Convert report.md to PDF with embedded images — all black text."""
import markdown
...
<div style="text-align:center;color:#666;font-size:9pt;margin-top:40px;border-top:1px solid #ddd;padding-top:10px;">
Jayant Batra — UCS645: Parallel & Distributed Computing — Assignment 5</div>
</body></html>"""

html = embed_images(html, '.')
HTML(string=html).write_pdf('Assignment_5_Report.pdf')
print("PDF generated: Assignment_5_Report.pdf")
