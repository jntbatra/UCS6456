...
body {{ font-family: 'Segoe UI', Tahoma, sans-serif; line-height: 1.6; color: #333; font-size: 11pt; }}
h1 {{ color: #2c3e50; border-bottom: 3px solid #3498db; padding-bottom: 10px; font-size: 22pt; }}
h2 {{ color: #2980b9; border-bottom: 1px solid #ddd; padding-bottom: 5px; margin-top: 30px; font-size: 16pt; }}
h3 {{ color: #27ae60; font-size: 13pt; }}
...
blockquote {{ border-left: 4px solid #3498db; margin: 10px 0; padding: 10px 20px; background: #f0f7ff; }}
