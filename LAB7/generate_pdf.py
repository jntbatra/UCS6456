...
Jayant Batra — UCS645: Parallel & Distributed Computing — Assignment 7</div>
</body></html>"""

html = embed_images(html, '.')
HTML(string=html).write_pdf('Assignment_7_Report.pdf')
print("PDF generated: Assignment_7_Report.pdf")
