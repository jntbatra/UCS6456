...
Jayant Batra — UCS645: Parallel & Distributed Computing — Assignment 6</div>
</body></html>"""

html = embed_images(html, '.')
HTML(string=html).write_pdf('Assignment_6_Report.pdf')
print("PDF generated: Assignment_6_Report.pdf")
