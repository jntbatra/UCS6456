...
Jayant Batra — UCS645: Parallel & Distributed Computing — Assignment 8</div>
</body></html>"""

html = embed_images(html, '.')
HTML(string=html).write_pdf('Assignment_8_Report.pdf')
print("PDF generated: Assignment_8_Report.pdf")
